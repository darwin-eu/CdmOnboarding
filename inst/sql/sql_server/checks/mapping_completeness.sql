select 'Condition' as "Domain",
        ...
        sum(case when is_mapped > 0 then num_records else 0 end) as "#Records Mapped",
        100.0*sum(case when is_mapped > 0 then num_records else 0 end)/sum(num_records) as "%Records Mapped"
from
(
select case when condition_concept_id > 0 then 1 else 0 end as is_mapped, count_big(*) as num_records
...
from
(
select case when procedure_concept_id > 0 then 1 else 0 end as is_mapped, count_big(*) as num_records
...
from
(
select case when device_concept_id > 0 then 1 else 0 end as is_mapped, count_big(*) as num_records
...
from
(
select case when drug_concept_id > 0 then 1 else 0 end as is_mapped, count_big(*) as num_records
...
from
(
select case when observation_concept_id > 0 then 1 else 0 end as is_mapped, count_big(*) as num_records
...
from
(
select case when measurement_concept_id > 0 then 1 else 0 end as is_mapped, count_big(*) as num_records
...
from
(
select case when visit_concept_id > 0 then 1 else 0 end as is_mapped, count_big(*) as num_records
...
from
(
   select case when unit_concept_id > 0 then 1 else 0 end as is_mapped, count_big(*) as num_records
   from @cdmDatabaseSchema.measurement
...
from
(
   select case when specialty_concept_id > 0 then 1 else 0 end as is_mapped, count_big(*) as num_records
...
from
(
   select case when specimen_concept_id > 0 then 1 else 0 end as is_mapped, count_big(*) as num_records
...
from
(
   select case when cause_concept_id > 0 then 1 else 0 end as is_mapped, count_big(*) as num_records
...
from
(
   select case when condition_status_concept_id > 0 then 1 else 0 end as is_mapped, count_big(*) as num_records
   from @cdmDatabaseSchema.condition_occurrence
