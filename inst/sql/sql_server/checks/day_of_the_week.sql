...
SELECT
    'Condition' AS domain,
    DATEDIFF(day, '1900-01-01', condition_start_date) % 7 + 1 AS day_of_the_week,
...
SELECT
    'Drug' AS domain,
    DATEDIFF(day, '1900-01-01', drug_exposure_start_date) % 7 + 1 AS day_of_the_week,
    COUNT_BIG(*) AS n_records
...
SELECT
    'Procedure' AS domain,
    DATEDIFF(day, '1900-01-01', procedure_date) % 7 + 1 AS day_of_the_week,
    COUNT_BIG(*) AS n_records
...
SELECT
    ...
    DATEDIFF(day, '1900-01-01', measurement_date) % 7 + 1 AS day_of_the_week,
    COUNT_BIG(*) AS n_records
...
SELECT
    ...
    DATEDIFF(day, '1900-01-01', observation_date) % 7 + 1 AS day_of_the_week,
    COUNT_BIG(*) AS n_records
...
SELECT
    'Device' AS domain,
    DATEDIFF(day, '1900-01-01', device_exposure_start_date) % 7 + 1 AS day_of_the_week,
    COUNT_BIG(*) AS n_records
...
SELECT
    'Visit' AS domain,
    DATEDIFF(day, '1900-01-01', visit_start_date) % 7 + 1 AS day_of_the_week,
    COUNT_BIG(*) AS n_records
...
SELECT
    ...
    DATEDIFF(day, '1900-01-01', visit_detail_start_date) % 7 + 1 AS day_of_the_week,
    COUNT_BIG(*) AS n_records
...
SELECT
    'Death' AS domain,
    DATEDIFF(day, '1900-01-01', death_date) % 7 + 1 AS day_of_the_week,
    COUNT_BIG(*) AS n_records
