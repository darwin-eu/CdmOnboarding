...
UNION ALL
select 'note_nlp' as tablename, count_big(*) as count, NULL as n_persons from @cdmDatabaseSchema.note_nlp
UNION ALL
...
UNION ALL
select 'fact_relationship' as tablename, count_big(*) as count, NULL as n_persons from @cdmDatabaseSchema.fact_relationship
UNION ALL
select 'metadata' as tablename, count_big(*) as count, NULL as n_persons from @cdmDatabaseSchema.metadata
UNION ALL
select 'cdm_source' as tablename, count_big(*) as count, NULL as n_persons from @cdmDatabaseSchema.cdm_source
{@cdmVersion == '5.4'} ? {
UNION ALL
select 'episode' as tablename, count_big(*) as count, count_big(distinct person_id) as n_persons from @cdmDatabaseSchema.episode
UNION ALL
select 'episode_event' as tablename, count_big(*) as count, NULL as n_persons from @cdmDatabaseSchema.episode_event
}
